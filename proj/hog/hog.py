...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0=0,score1=0,last=last_score,running=running_high):
        if who==0:
            score=score0
        if who==1:
            score=score1
        if score-last>running:
            running=score-last
            print(running,'point(s)!','The most yet for Player',who)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score+temp,opponent_score):
        return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score, opponent_score, cutoff=9, num_rolls=2)
